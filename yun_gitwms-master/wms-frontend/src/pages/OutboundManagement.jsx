          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-white/5">
              {(Array.isArray(orders) ? orders : []).map((order) => (
                <tr key={order.id} className="hover:bg-white/5 transition-colors group h-[72px]">
                  ...
                  <td className="px-8 py-5">
                    <span className="text-[10px] font-bold text-zinc-500 border border-white/10 px-2 py-0.5 rounded-full">{order.outType}</span>
                  </td>
              ...
              {orders.length === 0 && !loading && (
                <tr><td colSpan="5" className="px-8 py-20 text-center text-zinc-700 uppercase tracking-[0.5em] text-[10px] font-black">No Active Dispatches</td></tr>
              )}
            </tbody>
          </table>
        </div>
            ...
            <form onSubmit={handleCreate} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    >
                        <option value="Sale" className="bg-[#121414]">Sale</option>
                        <option value="Sample" className="bg-[#121414]">Sample</option>
                        <option value="RMA" className="bg-[#121414]">RMA</option>
                    </select>
                </div>
                <div className="space-y-2">
